    ...
    <header className='h-16 shadow-md bg-white fixed w-full z-30'>
        <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
            ...
            <div>
                {
                    user?._id ? (
                        <button onClick={handleLogout} className=' px-3 py-1 rounded-full text-white bg-red-600 hover: bg-red-600 '>Logout</button>
                    )
                    :
                    (
                       <Link to={"/login"} className=' px-3 py-1 rounded-full text-white bg-red-600 hover: bg-red-600 '>Login</Link>
                    )
                }
